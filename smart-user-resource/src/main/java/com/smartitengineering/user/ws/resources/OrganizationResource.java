...
public class OrganizationResource extends AbstractResource {
    ...
    public Response updatePost(@HeaderParam("Content-type") String contentType, String message) {
        ...
        if (isHtmlPost) {
            ...
            try {
                ...
                newOrganization.setCreationDate(oldOrganization.getCreationDate());
                ...
                responseBuilder.location(getAbsoluteURIBuilder().path(OrganizationResource.class).build(uniqueShortName));
            } catch (Exception ex) {
                responseBuilder = Response.status(Status.INTERNAL_SERVER_ERROR);
            }
        }
    ...
    private Feed getOrganizationFeed() throws UriBuilderException, IllegalArgumentException {
        ...
        altLink.setHref(getRelativeURIBuilder().path(OrganizationResource.class).path(ORGANIZATION_CONTENT_METHOD).build(organization.getUniqueShortName()).toString());
        altLink.setRel(Link.REL_ALTERNATE);
        altLink.setMimeType(MediaType.APPLICATION_JSON);
        organizationFeed.addLink(altLink);
        
        Link usersLink = getAbderaFactory().newLink();
        usersLink.setHref(getRelativeURIBuilder().path(OrganizationUsersResource.class).build(organization.getUniqueShortName()).toString());
        ...
        privilegesLink.setHref(getRelativeURIBuilder().path(OrganizationPrivilegesResource.class).build(organization.getUniqueShortName()).toString());
        ...
        securedObjectsLink.setHref(getRelativeURIBuilder().path(OrganizationSecuredObjectsResource.class).build(organization.getUniqueShortName()).toString());
        ...
        userGroupsLink.setHref(getRelativeURIBuilder().path(OrganizationUserGroupsResource.class).build(organization.getUniqueShortName()).toString());
